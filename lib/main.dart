          ...
          child: new InkWell(
            onTap: () {
              Navigator.of(context).push(new MaterialPageRoute(
                  builder: (context) => PageDetailMovies(
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: new Container(
          ...
          child: new Row(
            children: [
              new IconsTextRow(iconData: Icons.favorite, text: "Favorite"),
              new IconsTextRow(iconData: Icons.delete, text: "Delete"),
              new IconsTextRow(iconData: Icons.rate_review, text: "Rate"),
            ],
          ),
        ));
  }
